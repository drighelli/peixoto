...
ph1 <- pheatmap(log(de.genes.counts[filter2,]+1), cluster_cols=TRUE, scale="row", 
            color=pal, border_color=NA, fontsize_row=10, kmeans_k=5, annotation_col=ann.col)
save_pheatmap_pdf(filename="plots/heatmap_kmeans_k5.pdf", plot=ph1, width=20, height=20)
