...
ph1 <- pheatmap(log(de.genes.counts1[filter2,]+1), cluster_cols=TRUE, scale="row", 
            color=pal, border_color=NA, fontsize_row=9, fontsize_col=9, 
            annotation_col=ann.col)

save_pheatmap_pdf(filename="plots/heatmap.pdf", plot=ph1, width=20, height=20)
```
...
save_pheatmap_pdf(filename="plots/heatmap_kmeans_k4.pdf", plot=ph1, width=20, height=20)
