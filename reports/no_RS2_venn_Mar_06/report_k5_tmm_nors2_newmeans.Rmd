...
Venn2de(x=kowthc5.sign.genes.entrez, y=kowtsd5.sign.genes.entrez, 
...
geneProfileLucia(normalized.counts=normExprData, 
            design.matrix=designMatrix, 
            gene.name=int.genes$gene[6],
            res.o=int.genes, show.plot=TRUE, plotly.flag=TRUE)

geneProfileLucia(normalized.counts=normExprData, 
            design.matrix=designMatrix, 
            gene.name=int.genes$gene[7],
            res.o=int.genes, show.plot=TRUE, plotly.flag=TRUE)

geneProfileLucia(normalized.counts=normExprData, 
            design.matrix=designMatrix, 
            gene.name=int.genes$gene[8],
            res.o=int.genes, show.plot=TRUE, plotly.flag=TRUE)

geneProfileLucia(normalized.counts=normExprData, 
            design.matrix=designMatrix, 
            gene.name=int.genes$gene[9],
            res.o=int.genes, show.plot=TRUE, plotly.flag=TRUE)

geneProfileLucia(normalized.counts=normExprData, 
            design.matrix=designMatrix, 
            gene.name=int.genes$gene[10],
            res.o=int.genes, show.plot=TRUE, plotly.flag=TRUE)

geneProfileLucia(normalized.counts=normExprData, 
            design.matrix=designMatrix, 
            gene.name=int.genes$gene[11],
            res.o=int.genes, show.plot=TRUE, plotly.flag=TRUE)

geneProfileLucia(normalized.counts=normExprData, 
            design.matrix=designMatrix, 
            gene.name=int.genes$gene[12],
            res.o=int.genes, show.plot=TRUE, plotly.flag=TRUE)

geneProfileLucia(normalized.counts=normExprData, 
            design.matrix=designMatrix, 
            gene.name=int.genes$gene[13],
            res.o=int.genes, show.plot=TRUE, plotly.flag=TRUE)

geneProfileLucia(normalized.counts=normExprData, 
            design.matrix=designMatrix, 
            gene.name=int.genes$gene[14],
            res.o=int.genes, show.plot=TRUE, plotly.flag=TRUE)

geneProfileLucia(normalized.counts=normExprData, 
            design.matrix=designMatrix, 
            gene.name=int.genes$gene[15],
            res.o=int.genes, show.plot=TRUE, plotly.flag=TRUE)

geneProfileLucia(normalized.counts=normExprData, 
            design.matrix=designMatrix, 
            gene.name=int.genes$gene[16],
            res.o=int.genes, show.plot=TRUE, plotly.flag=TRUE)
